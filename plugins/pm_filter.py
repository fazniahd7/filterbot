...
async def next_page(bot, query):
    ...
    btn.append(
    [InlineKeyboardButton("𝗛𝗢𝗪 𝗧𝗢 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 🤔", url="https://telegram.me/DownloadDulink/7"),]
)
    ...
    if query.data.startswith("file"):
        ...
        try:
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                dulink =f"https://hit-link.in/st?api=3b54086b1d604260b2843af43a2e0892b0ebe9f9&url=https://telegram.me/{temp.U_NAME}?start={ident}_{file_id}"
                print(dulink)
...
async def auto_filter(client, msg, spoll=False):
    ...
    if settings["button"]:
        btn = [
            [
                InlineKeyboardButton(
                    text=f"[{get_size(file.file_size)}] {file.file_name}", 
                    url=f"https://hit-link.in/st?api=3b54086b1d604260b2843af43a2e0892b0ebe9f9&url=https://telegram.me/{temp.U_NAME}?start=pre_{file.file_id}"
                ),
            ]
            for file in files
        ]
    ...
    btn.append(
    [InlineKeyboardButton("𝗛𝗢𝗪 𝗧𝗢 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 🤔", url="https://t.me/DownloadDulink/7"),]
)
